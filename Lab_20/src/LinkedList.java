...
public class LinkedList {
	...
	public void append(Money m) {
		...
		ListNode newNode = new ListNode(m); //Creates new node
	...
	public void prepend(Money d) {
		...
		ListNode newNode = new ListNode(d); //Creates a new node
		...
		if (last == first) //If the list was empty, update the last note
			last = newNode;
		length++; //Increases the length of the list
